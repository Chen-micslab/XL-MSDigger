...
class SVM_parameter:
    para = {'cv':[2,3],
            ...
            'c':[10, 50, 100, 200],
            'max_train_sample':[500, 1000, 2000]}
...
class Rescore_DNN():
    ...
    def cv_score(self, args, data, feature_dir):                     
        print(data)
        feature_list = ['charge', 'score', 'len1', 'len2', 'rt_AE', 'match_num', 'match_num1', 'match_num2',
                    ...
                    for max_trian_number in max_trian_number_list:
                        if cv > 1:
                            ...
                            for i in range(cv):
                                ...
                                print(len(train_t_df['title']))
                                print(len(train_d_df['title']))
...
class Rescore_SVM():
    def cv_score(self, data):                      
        ...
        feature_list = ['score', 'rt_AE', 'cosine']

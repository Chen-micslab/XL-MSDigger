...
def get_args():  ##设置需要传入的参数
    ...
    parser.add_argument('--experiment_library', type=str, default='/data/moran/XL-MSDigger/test_data/total_crosslink_precursor_normal_library.csv')
    parser.add_argument('--aim_protein', type=str, default='/data/moran/XL-MSDigger/test_data/PFDN_PPI.csv')  ###包含target proteins或者PPI的文件
    parser.add_argument('--aim_type', type=int, default=1)  ###0代表单独的protein，1代表PPI
    parser.add_argument('--fasta_dir', type=str, default='/data/moran/XL-MSDigger/test_data/human reviewed.fasta')  ###   

...
class plink2_with_DA_mgf():  ######适用于brukerDA软件生成的mgf文件经过我们自己的程序转换后产生的mgf文件的plink2搜库结果
    ...
    def genenrate_all_crosslink_fragment(self, plink_data, mgf_dir):
        ...
        return complete_normal_library, TT_normal_library, TT_DIANN_library
    ...
    def process(self, plinkfile, mgf_dir):
        ...
        complete_normal_library, TT_normal_library, TT_DIANN_library = self.genenrate_all_crosslink_fragment(plink_crosslink_data_ccs, mgf_dir)
        candidate_normal_library, candidate_TT_normal_library, candidate_TT_DIANN_library = self.genenrate_all_crosslink_fragment(
            plink_crosslink_candidate, mgf_dir)

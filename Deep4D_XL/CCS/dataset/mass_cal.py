...
if __name__ == '__main__':
    a = mz_cal()
    print(a.crosslink_peptide_msms_m_z('NISRLQAEIEGLKUGQRXTKUTEISEMNR', 'DSS','2b', 5, 3,'noloss'))
    print(a.crosslink_peptide_msms_m_z('NISRLQAEIEGLKUGQRXTKUTEISEMNR', 'SS', '2b', 5, 3, 'noloss'))

...
def get_args():             
    ...
    parser.add_argument('--load_msms_param_dir', type=str, default='Deep4D_XL/MSMS/checkpoint/msms.pth')                            
    parser.add_argument('--seed', type=int, default=1)                            
    parser.add_argument('--filename', type=str, default='total_crosslink_msms_filter_test')
...
def predict_label_msms(args):
    ...
    from model.crosslink_msms_model_noncleavable import Transformer as deep_model
    ...
    total_peptide_msms = torch.zeros((total_lenth, 980)).to(device=device, dtype=torch.float32)
